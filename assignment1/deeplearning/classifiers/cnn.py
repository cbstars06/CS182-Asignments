...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        a1,cache1 = affine_relu_forward(conv_out.reshape((N,F*H*W)),W2,b2)

        scores,cache2 = affine_forward(a1,W3,b3)
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
        ...
        dout,grads['W1'],grads['b1'] = conv_relu_pool_backward(dout.reshape((N,F,H,W)),conv_cache)
